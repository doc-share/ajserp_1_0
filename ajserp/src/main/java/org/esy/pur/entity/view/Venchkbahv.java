...
@Entity
@EntityInfo("廠商調價表頭檔")
@Table(name = "Venchkbahv")
@Subselect("select a.* from venchk_bah a")
@Synchronize("venchk_bah")

public class Venchkbahv extends BaseProperties {
	...
	@Transient
	@JsonProperty("venchkbats") //宿主(要引用明細檔)(venchkbats要跟grid key值一樣)
	private List<Venchkbat> venchkbats = new ArrayList<Venchkbat>();
	
	
	public List<Venchkbat> getVenchkbats() {
		return venchkbats;
	}

	public void setVenchkbats(List<Venchkbat> venchkbats) {
		this.venchkbats = venchkbats;
	}
	 ...
	 * 
	 	 */
    	public Venchkbahv( String nbr, Date nbrdate, String chk_type, String ven_nbr, String chk_proc, Double chk_ratio, String item_nbrf, String item_nbrt, String m_typef, String m_typet, String remark ) {
		super();
				this.nbr = nbr;
