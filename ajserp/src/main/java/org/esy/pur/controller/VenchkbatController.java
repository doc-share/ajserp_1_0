 ...
 */
@Controller
@RequestMapping("/api/pur/venchkbat")
public class VenchkbatController {

    public static final String AUTHORITY = "pur_venchkbat";

	@Autowired
	private ILoginService loginService;

	@Autowired
	private IVenchkbatService venchkbatService;
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Venchkbat o, HttpServletRequest request) {
		...
		try {
			//o.setUid(null);
			resp = new Response(0, "Save success.", venchkbatService.save(o));
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Venchkbat o = venchkbatService.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Venchkbat, pageable
	 * @return HttpResult
	 * @date Wed Aug 05 14:12:48 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Venchkbat venchkbat, Pageable pageable) {
		if (venchkbat == null) {
			venchkbat = new Venchkbat();
		}
		return new HttpResult(venchkbatService.query(venchkbat, pageable));
	}
