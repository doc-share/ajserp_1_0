...
@EntityInfo("銷項發票表頭檔")
@Table(name = "Oivcbahv")
@Subselect("select a.* from oivc_bah a")
@Synchronize("oivc_bah")
public class Oivcbahv extends BaseProperties {
	...
	@Transient
	@JsonProperty("oivcbats") //宿主(要引用明細檔)(oivcbats要跟grid key值一樣)
	private List<Oivcbat> oivcbats = new ArrayList<Oivcbat>();
	
     public List<Oivcbat> getOivcbats() {
		return oivcbats;
	}

	public void setOivcbats(List<Oivcbat> oivcbats) {
		this.oivcbats = oivcbats;
	}
