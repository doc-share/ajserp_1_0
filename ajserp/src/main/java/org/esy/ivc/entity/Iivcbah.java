 ...
 */
@Entity
@Table(name = "iivc_bah" ,indexes = { @Index(name = "created", columnList = "created"), 
@Index(name = "updated", columnList = "updated")})
@EntityInfo("進項發票表頭檔")
public class Iivcbah extends BaseProperties {
