 ...
 */
@Entity
@Table(name = "oivc_bat" ,indexes = { @Index(name = "created", columnList = "created"), 
@Index(name = "updated", columnList = "updated")})
@EntityInfo("銷項發票明細檔")
public class Oivcbat extends BaseProperties {
	...
	@FieldInfo("出貨明細")
	@FilterInfo(ListValue = "")
	@Column(name = "shprem", length =32  )
	private String shprem ;
	 ...
	 * 
	 	 */
    	public Oivcbat( String nbr, Integer seq, String ioseq, String item_nbr, String item_desc, String itemname, String unit, Double qty, Double price, Double amt, Date nbrdate, String io_p, String shprem, String remark, String tranok, String tranop, Integer trancnt ) {
		super();
				this.nbr = nbr;
				this.seq = seq;
				this.ioseq = ioseq;
	 ...
	 *			出貨明細
	 */
	public void setShprem(String Shprem) {
		this.shprem = Shprem;
	}
		/**
	 * @return remark
