 ...
 */
@Controller
@RequestMapping("/api/ivc/iivcbah")
public class IivcbahController {

    public static final String AUTHORITY = "ivc_mapdi";

	@Autowired
	private ILoginService loginService;

	@Autowired
	private IIivcbahService iivcbahService;
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Iivcbahv o, HttpServletRequest request) {
		...
		try {
			//o.setUid(null);
			resp = new Response(0, "Save success.", iivcbahService.save(o));
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Iivcbahv o = iivcbahService.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Iivcbah, pageable
	 * @return HttpResult
	 * @date Thu Jul 30 16:25:13 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Iivcbahv iivcbahv, Pageable pageable) {
		if (iivcbahv == null) {
			iivcbahv = new Iivcbahv();
		}
		return new HttpResult(iivcbahService.query(iivcbahv, pageable));
	}
