 ...
 */
@Entity
@Table(name = "cashbook" ,indexes = { @Index(name = "created", columnList = "created"), 
@Index(name = "updated", columnList = "updated")})
@EntityInfo("現金資料明細檔")
public class Cashbook extends BaseProperties {
	 ...
	 * 
	 	 */
    	public Cashbook( String nbr, String acc_nbr, String io_p, String b_nbr, Date nbrdate, Double amt, String remark, String io_dbf, String io_nbr, String cus_nbr, String ven_nbr, String acr_dbf, String acr_nbr, String chk_nbr, String status, String sstatus, String acc_id, Date crt_date, String crt_user, Date edit_date, String edit_user, String tranok, String tranop, Integer trancnt ) {
		super();
				this.nbr = nbr;
