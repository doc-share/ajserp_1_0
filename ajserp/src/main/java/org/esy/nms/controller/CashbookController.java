 ...
 */
@Controller
@RequestMapping("/api/nms/cashbook")
public class CashbookController {

    public static final String AUTHORITY = "nms_mapz2";
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Cashbook o, HttpServletRequest request) {
		...
		try {
			//o.setUid(null);
			resp = new Response(0, "Save success.", cashbookService.save(o));
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Cashbook o = cashbookService.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Cashbook, pageable
	 * @return HttpResult
	 * @date Thu Jul 30 10:50:38 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Cashbook cashbook, Pageable pageable) {
		if (cashbook == null) {
			cashbook = new Cashbook();
		}
		return new HttpResult(cashbookService.query(cashbook, pageable));
	}
