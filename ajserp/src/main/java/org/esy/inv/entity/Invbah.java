 ...
 */
@Entity
@Table(name = "inv_bah" ,indexes = { @Index(name = "created", columnList = "created"), 
@Index(name = "updated", columnList = "updated")})
@EntityInfo("出入庫單據表頭檔")
public class Invbah extends BaseProperties {
	 ...
	 * 
	 	 */
    	public Invbah( String nbr, String io_p, Date nbrdate, String ware_nbr, String remark, String status, String last_user, Date crt_date, String crt_user, Date edit_date, String edit_user, String tranok, String tranop, Integer trancnt ) {
		super();
				this.nbr = nbr;
				this.io_p = io_p;
