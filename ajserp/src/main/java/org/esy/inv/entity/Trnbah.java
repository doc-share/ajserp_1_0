 ...
 */
@Entity
@Table(name = "trn_bah" ,indexes = { @Index(name = "created", columnList = "created"), 
@Index(name = "updated", columnList = "updated")})
@EntityInfo("庫存調撥表頭檔")
public class Trnbah extends BaseProperties {
	 ...
	 * 
	 	 */
    	public Trnbah( String nbr, Date nbrdate, String ware_nbro, String ware_nbri, String remark, String status, String last_user, Date crt_date, String crt_user, Date edit_date, String edit_user, String tranok, String tranop, Integer trancnt ) {
		super();
				this.nbr = nbr;
