...
@EntityInfo("報廢單表頭檔")
@Table(name = "Antbahv")
@Subselect("select a.* from ant_bah a")
@Synchronize("ant_bah")

public class Antbahv extends BaseProperties {
	...
	@Transient
	@JsonProperty("antbats") //宿主(要引用明細檔)(antbats要跟grid key值一樣)
	private List<Antbat> antbats = new ArrayList<Antbat>();
	
     public List<Antbat> getAntbats() {
		return antbats;
	}

	public void setAntbats(List<Antbat> antbats) {
		this.antbats = antbats;
	}
	 ...
	 * 
	 	 */
    	public Antbahv( String nbr, Date nbrdate, String ware_nbr, String remark, String status, String last_user, Date crt_date, String crt_user, Date edit_date, String edit_user, String tranok, String tranop, Integer trancnt ) {
		super();
				this.nbr = nbr;
