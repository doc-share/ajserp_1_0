 ...
 */
@Entity
@Table(name = "ant_bah" ,indexes = { @Index(name = "created", columnList = "created"), 
@Index(name = "updated", columnList = "updated")})
@EntityInfo("報廢單表頭檔")
public class Antbah extends BaseProperties {
	 ...
	 * 
	 	 */
    	public Antbah( String nbr, Date nbrdate, String ware_nbr, String remark, String status, String last_user, Date crt_date, String crt_user, Date edit_date, String edit_user, String tranok, String tranop, Integer trancnt ) {
		super();
				this.nbr = nbr;
