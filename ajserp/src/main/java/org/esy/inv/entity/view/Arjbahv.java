...
@EntityInfo("庫存調整單表頭檔")
@Table(name = "Arjbahv")
@Subselect("select a.* from arj_bah a")
@Synchronize("arj_bah")

public class Arjbahv extends BaseProperties {
	...
	@Transient
	@JsonProperty("arjbats") //宿主(要引用明細檔)(arjbats要跟grid key值一樣)
	private List<Arjbat> arjbats = new ArrayList<Arjbat>();
	

     public List<Arjbat> getArjbats() {
		return arjbats;
	}

	public void setArjbats(List<Arjbat> arjbats) {
		this.arjbats = arjbats;
	}
	 ...
	 * 
	 	 */
    	public Arjbahv( String nbr, Date nbrdate, String ware_nbr, String remark, String status, String last_user, Date crt_date, String crt_user, Date edit_date, String edit_user, String tranok, String tranop, Integer trancnt ) {
		super();
				this.nbr = nbr;
