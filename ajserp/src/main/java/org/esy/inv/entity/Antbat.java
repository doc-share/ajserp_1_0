 ...
 */
@Entity
@Table(name = "ant_bat" ,indexes = { @Index(name = "created", columnList = "created"), 
@Index(name = "updated", columnList = "updated")})
@EntityInfo("報廢單明細檔")
public class Antbat extends BaseProperties {
	 ...
	 * 
	 	 */
    	public Antbat( String nbr, Integer seq, String ioseq, String item_nbr, String item_desc, String pro_nbr, String ware_nbr, String unit, Double qty, String kcnbr1, String kcnbr2, Double jqty, String remark, Date nbrdate, String io_p, String tranok, String tranop, Integer trancnt ) {
		super();
				this.nbr = nbr;
				this.seq = seq;
				this.ioseq = ioseq;
