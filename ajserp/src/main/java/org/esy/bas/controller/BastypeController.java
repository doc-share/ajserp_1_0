 ...
 */
@Controller
@RequestMapping("/api/bas/bastype")
public class BastypeController {

    public static final String AUTHORITY = "bas_map18c";
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Bastype o, HttpServletRequest request) {
		...
		try {
			//o.setUid(null);
			resp = new Response(0, "Save success.", bastypeService.save(o));
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Bastype o = bastypeService.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Bastype, pageable
	 * @return HttpResult
	 * @date Thu Jul 23 13:17:38 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Bastype bastype, Pageable pageable) {
		if (bastype == null) {
			bastype = new Bastype();
		}
		return new HttpResult(bastypeService.query(bastype, pageable));
	}
