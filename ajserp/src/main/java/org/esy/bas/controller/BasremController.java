...
import org.esy.bas.service.IBasremService;
 ...
 *  @version v2.0
 * @date Thu Jul 23 13:41:27 CST 2020			
 */
@Controller
@RequestMapping("/api/bas/basrem")
public class BasremController {

    public static final String AUTHORITY = "bas_map181";

	@Autowired
	private ILoginService loginService;

	@Autowired
	private IBasremService basremService;
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Basrem o, HttpServletRequest request) {
		...
		try {
			//o.setUid(null);
			resp = new Response(0, "Save success.", basremService.save(o));
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Basrem o = basremService.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Basrem, pageable
	 * @return HttpResult
	 * @date Thu Jul 23 13:41:27 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Basrem basrem, Pageable pageable) {
		if (basrem == null) {
			basrem = new Basrem();
		}
		return new HttpResult(basremService.query(basrem, pageable));
	}
