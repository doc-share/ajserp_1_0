 ...
 */
@Controller
@RequestMapping("/api/bas/basbank")
public class BasbankController {

    public static final String AUTHORITY = "nms_mapz1";

	@Autowired
	private ILoginService loginService;

	@Autowired
	private IBasbankService basbankService;
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Basbank o, HttpServletRequest request) {
		...
		try {
			//o.setUid(null);
			resp = new Response(0, "Save success.", basbankService.save(o));
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Basbank o = basbankService.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Basbank, pageable
	 * @return HttpResult
	 * @date Thu Jul 30 10:23:44 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Basbank basbank, Pageable pageable) {
		if (basbank == null) {
			basbank = new Basbank();
		}
		return new HttpResult(basbankService.query(basbank, pageable));
	}
