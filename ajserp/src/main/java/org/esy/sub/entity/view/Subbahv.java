...
@EntityInfo("委外加工表頭檔")
@Table(name = "Subbahv")
@Subselect("select a.* from sub_bah a")
@Synchronize("sub_bah")

public class Subbahv extends BaseProperties {
	...
	@Transient
	@JsonProperty("subbats") //宿主(要引用明細檔)(subbats要跟grid key值一樣)
	private List<Subbat> subbats = new ArrayList<Subbat>();
	
	@Transient
	@JsonProperty("subuseos") //宿主(要引用明細檔)(subuseos要跟grid key值一樣)
	private List<Subuseo> subuseos = new ArrayList<Subuseo>();
	
     public List<Subbat> getSubbats() {
		return subbats;
	}

	public void setSubbats(List<Subbat> subbats) {
		this.subbats = subbats;
	}

	public List<Subuseo> getSubuseos() {
		return subuseos;
	}

	public void setSubuseos(List<Subuseo> subuseos) {
		this.subuseos = subuseos;
	}
	 ...
	 * 
	 	 */
    	public Subbahv( String ord_nbr, String oem_nbr, String nbr, Date nbrdate, String ven_nbr, String ven_nbr1, String sale_nbr, String ware_nbro, String ware_nbri, Double tot_amt, Date plan_date, String remark, String status, String acc_id, String last_user, String item_nbr, String work_desc, Integer sure, String work_nbr, Integer is_prn, Date crt_date, String crt_user, Date edit_date, String edit_user, String tranok, String tranop, Integer trancnt ) {
		super();
