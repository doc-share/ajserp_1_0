 ...
 */
@Entity
@Table(name = "oem_useo" ,indexes = { @Index(name = "created", columnList = "created"), 
@Index(name = "updated", columnList = "updated")})
@EntityInfo("委外加工收料耗料明細")
public class Oemuseo extends BaseProperties {
	 ...
	 * 
	 	 */
    	public Oemuseo( String nbr, String ioseq, String bat_ioseq, String item_nbr, String item_desc, String pro_nbr, String ware_nbr, String unit, Double qty, String kcnbr1, String kcnbr2, Double jqty, String remark, Date nbrdate, String io_p, String tranok, String tranop, Integer trancnt ) {
		super();
				this.nbr = nbr;
				this.ioseq = ioseq;
