 ...
 */
@Controller
@RequestMapping("/api/acc/accmst1")
public class Accmst1Controller {

    public static final String AUTHORITY = "acc_mapacc12";

	@Autowired
	private ILoginService loginService;

	@Autowired
	private IAccmst1Service accmst1Service;
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Accmst1 o, HttpServletRequest request) {
		...
		try {
			//o.setUid(null);
			resp = new Response(0, "Save success.", accmst1Service.save(o));
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Accmst1 o = accmst1Service.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Accmst1, pageable
	 * @return HttpResult
	 * @date Fri Jul 31 15:45:24 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Accmst1 accmst1, Pageable pageable) {
		if (accmst1 == null) {
			accmst1 = new Accmst1();
		}
		return new HttpResult(accmst1Service.query(accmst1, pageable));
	}
