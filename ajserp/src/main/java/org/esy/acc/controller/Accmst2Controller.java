 ...
 */
@Controller
@RequestMapping("/api/acc/accmst2")
public class Accmst2Controller {

    public static final String AUTHORITY = "acc_accmst2";

	@Autowired
	private ILoginService loginService;

	@Autowired
	private IAccmst2Service accmst2Service;
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Accmst2 o, HttpServletRequest request) {
		...
		try {
			//o.setUid(null);
			resp = new Response(0, "Save success.", accmst2Service.save(o));
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Accmst2 o = accmst2Service.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Accmst2, pageable
	 * @return HttpResult
	 * @date Fri Jul 31 15:45:52 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Accmst2 accmst2, Pageable pageable) {
		if (accmst2 == null) {
			accmst2 = new Accmst2();
		}
		return new HttpResult(accmst2Service.query(accmst2, pageable));
	}
