...
@EntityInfo("收款單轉傳票")
@Table(name = "Accbahv")
@Subselect("select a.* from acc_bah a")
@Synchronize("acc_bah")

public class Accbahv extends BaseProperties {
	...
	@Transient
	@JsonProperty("accbats") //宿主(要引用明細檔)(accbats要跟grid key值一樣)
	private List<Accbat> accbats = new ArrayList<Accbat>();
	
     public List<Accbat> getAccbats() {
		return accbats;
	}

	public void setAccbats(List<Accbat> accbats) {
		this.accbats = accbats;
	}
	 ...
	 * 
	 	 */
    	public Accbahv( String inv_type, String nbr, Date date, Double d_amt, Double c_amt, String status, String status1, String form_user, String chk_ctl, String last_user, Date crt_date, String crt_user, Date edit_date, String edit_user ) {
		super();
