package org.esy.shp.entity.view;
...
//	private String ware_desc;
	...
	@Transient
	@JsonProperty("shpbats") //宿主(要引用明細檔)(shpbats要跟grid key值一樣)
	private List<Shpbat> shpbats = new ArrayList<Shpbat>();
		
	
     public List<Shpbat> getShpbats() {
		return shpbats;
	}

	public void setShpbats(List<Shpbat> shpbats) {
		this.shpbats = shpbats;
	}
