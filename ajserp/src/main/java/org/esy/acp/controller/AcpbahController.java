 ...
 */
@Controller
@RequestMapping("/api/acp/acpbah")
public class AcpbahController {

    public static final String AUTHORITY = "acp_map83";

	@Autowired
	private ILoginService loginService;

	@Autowired
	private IAcpbahService acpbahService;
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Acpbahv o, HttpServletRequest request) {
		...
		try {
			//o.setUid(null);
			resp = new Response(0, "Save success.", acpbahService.save(o));
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Acpbahv o = acpbahService.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Acpbah, pageable
	 * @return HttpResult
	 * @date Thu Jul 30 09:44:42 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Acpbahv acpbahv, Pageable pageable) {
		if (acpbahv == null) {
			acpbahv = new Acpbahv();
		}
		return new HttpResult(acpbahService.query(acpbahv, pageable));
	}
