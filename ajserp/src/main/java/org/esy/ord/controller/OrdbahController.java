...
public class OrdbahController {
	...
	@Autowired
	private IOrdbahService ordbahService;
	...
	@ResponseBody
	public ResponseEntity<Response> save(@RequestBody Ordbahv o, HttpServletRequest request) {
		...
		try {
			//o.setUid(null);
			resp = new Response(0, "Save success.", ordbahService.save(o));
	...
	public ResponseEntity<Response> get(@PathVariable String uid, HttpServletRequest request) {
		...
		Ordbahv o = ordbahService.getByUid(uid);
		if (o == null) {
	 ...
	 * 
	 * @author <a href="mailto:ardui@163.com">ardui</a>
	 * @param Ordbah, pageable
	 * @return HttpResult
	 * @date Tue Jul 28 11:22:12 CST 2020	
	 */
	@RequestMapping(value = "query", method = RequestMethod.POST)
	public HttpResult query(@Valid @RequestBody(required = false) Ordbahv ordbahv, Pageable pageable) {
		if (ordbahv == null) {
			ordbahv = new Ordbahv();
		}
		return new HttpResult(ordbahService.query(ordbahv, pageable));
	}
