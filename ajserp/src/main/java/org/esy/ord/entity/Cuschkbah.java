 ...
 */
@Entity
@Table(name = "cuschk_bah" ,indexes = { @Index(name = "created", columnList = "created"), 
@Index(name = "updated", columnList = "updated")})
@EntityInfo("客戶調價表頭檔")
public class Cuschkbah extends BaseProperties {
	 ...
	 * 
	 	 */
    	public Cuschkbah( String nbr, Date nbrdate, String chk_type, String cus_nbr, String chk_proc, Double chk_ratio, String item_nbrf, String item_nbrt, String m_typef, String m_typet, String remark ) {
		super();
				this.nbr = nbr;
