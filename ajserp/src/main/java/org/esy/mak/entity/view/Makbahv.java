package org.esy.mak.entity.view;
...
@EntityInfo("製造命令單")
@Table(name = "Makbahv")
@Subselect("select a.* from mak_bah a")
@Synchronize("mak_bah")
public class Makbahv extends BaseProperties {
	...
	@Transient
	@JsonProperty("makbats") //宿主(要引用明細檔)(makbats要跟grid key值一樣)
	private List<Makbat> makbats = new ArrayList<Makbat>();
	
	@Transient
	@JsonProperty("makbat1s") //宿主(要引用明細檔)(makbat1s要跟grid key值一樣)
	private List<Makbat1> makbat1s = new ArrayList<Makbat1>();
	
     public List<Makbat> getMakbats() {
		return makbats;
	}

	public void setMakbats(List<Makbat> makbats) {
		this.makbats = makbats;
	}

	public List<Makbat1> getMakbat1s() {
		return makbat1s;
	}

	public void setMakbat1s(List<Makbat1> makbat1s) {
		this.makbat1s = makbat1s;
	}
	 ...
	 * 
	 	 */
    	public Makbahv( String nbr, Date nbrdate, String status, Date plan_date, Date actu_date, String remark, String user, String ctl, String user_code, String sale_id, Date mark_date, String ord_nbr, String desc_no, String pps_nbr, String pps_ioseq, Integer is_clt, Date crt_date, String crt_user, Date edit_date, String edit_user, String tranok, String tranop, Integer trancnt, String item_nbr, String ord_nbr1, Double hours, Double qty, Double ioqty, String ord_ioseq, String unit, String pro_nbr, Double tar_qty, String pur_ctl ) {
		super();
				this.nbr = nbr;
