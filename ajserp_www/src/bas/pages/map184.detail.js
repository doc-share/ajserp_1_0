define(function() {
    angular.module('app').controller('bas.map184.detail',
                ...
                del: function() {
                    dialog.confirm('确定删除当前数据?').then(function() {
                        scope.promise=utils.ajax({
                            method: 'DELETE',
                            url: "bas/basare/" + scope.model.uid,
                            mockUrl: "plugins/data/map184.detail.json"
                        }).then(function(res) {
                            toastr.info("数据删除成功!!!");
                            scope.uid = "";
                            scope.action.add();
                            scope.refreshtab("refreshbasare", {});
